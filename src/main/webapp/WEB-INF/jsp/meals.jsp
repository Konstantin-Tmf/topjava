...
<div class="jumbotron pt-4">
    <div class="container">
        ...
        <form id="filterForm" method="get" action="meals">
            <dl>
            ...
            <button class="btn btn-secondary mr-2" type="submit"><spring:message code="meal.filter"/></button>
            ...
            <div class="modal-body">
                <form id="detailsForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="calories" name="calories" min="10" max="5000" required>
                    </div>
                </form>
            </div>
