...
Функциональность сравнения списка юзеров по ВСЕМ полям у нас уже есть - мы просто делегируем сравнение объектов в `ru.javawebinar.topjava.UserTestData.MATCHER`. 
